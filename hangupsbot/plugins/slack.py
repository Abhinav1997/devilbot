        ...
        for sinkConfig in slack_sink:
            ...
            try:
                ...
                if event.conv_id in convlist:
                    ...
                    if bot.conversations.catalog[event.conv_id]["history"] or "devilbotr_privacy" not in sinkConfig or not sinkConfig["devilbotr_privacy"]:
