...
def _initialise(bot):
  plugins.register_user_command(["shakespeare"])
    
def shakespeare(bot, event, *args):
  ...
  insult = "Thou " + column1[random.randint(0,49)] + (" ") + column2[random.randint(1,49)] + (" ") + column3[random.randint(1,49)]
  insult = name + ', ' + insult
